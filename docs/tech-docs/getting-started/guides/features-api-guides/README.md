...
5. [Using event features with time series foundation models](using-event-features-with-time-series-foundation-models.md) - features as future covariates for pre-trained models
