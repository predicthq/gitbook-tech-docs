...
{% hint style="success" %}
It is difficult working out a suitable radius around your location so to make it easier please use our [Predicted Impact Area API](https://app.gitbook.com/s/kEFs8urDbSJqBmXUI3Lv/impact-area/get-impact-area) to determine the optimal area around your business.
{% endhint %}
