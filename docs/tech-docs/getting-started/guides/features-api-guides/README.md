...
3. [Demand Forecasting with Event Features](demand-forecasting-data-science-guides.md) - the full modeling workflow
4. [Using event features with time series foundation models](using-event-features-with-time-series-foundation-models.md) - features as future covariates for pre-trained models
