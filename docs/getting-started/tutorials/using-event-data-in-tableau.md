...
{% hint style="info" %}
For more information on using Control Center Search and exporting files, see [export-data-via-control-center.md](../guides/export-data-via-control-center.md "mention").
{% endhint %}
