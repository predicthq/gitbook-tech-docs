...
</code></pre></td></tr><tr><td><code>readiness_status</code><br>string</td><td><p>The value of this field determines whether or not the Analysis has successfully completed processing.</p><p></p><p>When you upload data for an Analysis the <code>readiness_status</code> will be set to <code>pending</code> until processing has completed.<br><br>Possible values:</p><ul><li><code>pending</code></li><li><code>failed</code></li><li><code>ready</code></li></ul><p>E.g. <code>ready</code></p></td></tr><tr><td><code>status</code><br>string</td><td><p>Status of the Analysis.<br><br>Possible values:</p><ul><li><code>active</code></li></ul><p>E.g. <code>active</code></p></td></tr><tr><td><code>processing_completed</code><br>object</td><td><p>Status of the Analysis processing stages. All stages will be present here and are reset to <code>false</code> whenever thr Analysis is refreshed (i.e., processing has been initiated).<br></p><p>E.g.</p><pre class="language-json"><code class="lang-json">{
