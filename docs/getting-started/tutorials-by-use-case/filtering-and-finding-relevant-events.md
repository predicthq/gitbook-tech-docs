...
* **Relevant Event Categories**: To identify [event categories](../predicthq-data/event-categories/) that are most relevant to your location, use [Beam](https://www.predicthq.com/support/beam-overview) in the [WebApp](https://control.predicthq.com/beam) or the [Beam API](../../api/beam/). Alternatively, start with our [industry recommendations](../guides/industry-specific-event-filters.md#relevant-event-categories) for which categories to start with.
...
Next, Tom plans to use use [Beam](https://www.predicthq.com/support/beam-overview) in the [WebApp](https://control.predicthq.com/beam) to help refine these categories further based on actual data-driven insights, tailored to his pizzeria.
...
* **Relevant Events**: Tom aims to pinpoint event categories that impact his business the most by using [Beam](https://www.predicthq.com/support/beam-overview) in the [WebApp](https://control.predicthq.com/beam). This will help him allocate his resources more effectively.
