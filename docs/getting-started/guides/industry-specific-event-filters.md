...
1. Create Saved Locations via [Location Insights](https://www.predicthq.com/support/category/location-insights) in the WebApp or at scale using the [Saved Locations API](https://docs.predicthq.com/api/saved-locations).
2. Configuration:
