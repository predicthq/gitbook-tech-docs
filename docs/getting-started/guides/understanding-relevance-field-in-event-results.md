...
{% hint style="info" %}
The other `start_around.*` parameters can be used to tune how the relevance of an event changes as its start date moves away from the origin. See the [parameter documentation](https://docs.predicthq.com/resources/events/#param-start-around) for details.
{% endhint %}
...
{% hint style="info" %}
The other `location_around.*` parameters can be used to further tune how the relevance of an event changes as its location moves away from the origin. See the [parameter documentation](https://docs.predicthq.com/resources/events/#param-loc-around) for details.
{% endhint %}
...
{% hint style="info" %}
See the [relevance parameter documentation](https://docs.predicthq.com/resources/events/#param-relevance) for more information about the `relevance` parameter.
{% endhint %}
