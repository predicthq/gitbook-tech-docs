...
</code></pre><p></p><p>E.g.  Residency <code>event-group</code> Entity:</p><pre class="language-json"><code class="lang-json">[
  {
...
</code></pre><p></p><p>E.g.  Venue Entity:</p><pre class="language-json"><code class="lang-json">[
  {
