...
</code></pre></td></tr><tr><td><code>event.entities</code><br>array</td><td><p>Venue entities linked to the physical event.</p><p></p><p>E.g.</p><pre class="language-json"><code class="lang-json">[
  {
