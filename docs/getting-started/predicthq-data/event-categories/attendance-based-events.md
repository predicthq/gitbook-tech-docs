...
For example, the [New Orleans Jazz and Heritage Festival](https://events.predicthq.com/events/8emKFNo6AAVzUJXdTB) has an Aviation Rank of 78 while [An Old Time Christmas](https://control.predicthq.com/search/events/ToZHJ3MHBrQGsw45Rx) (a seasonal light show) has an Aviation Rank of 0.
