...
* [Tutorials by Use Case](getting-started/tutorials-by-use-case/README.md)
  * [Filtering and Finding Relevant Events](getting-started/tutorials-by-use-case/filtering-and-finding-relevant-events.md)
  * [Improving Demand Forecasting Models with Event Features](getting-started/tutorials-by-use-case/improving-demand-forecasting-models-with-event-features.md)
  * [Using Event Data in Power BI](getting-started/tutorials-by-use-case/using-event-data-in-power-bi.md)
  * [Using Event Data in Tableau](getting-started/tutorials-by-use-case/using-event-data-in-tableau.md)
  * [Connecting to PredictHQ APIs with Microsoft Excel](getting-started/tutorials-by-use-case/connecting-to-predicthq-apis-with-microsoft-excel.md)
  * [Loading Event Data into a Data Warehouse](getting-started/tutorials-by-use-case/loading-event-data-into-a-data-warehouse.md)
  * [Displaying Events in a Heatmap Calendar](getting-started/tutorials-by-use-case/displaying-events-in-a-heatmap-calendar.md)
  * [Displaying Events on a Map](getting-started/tutorials-by-use-case/displaying-events-on-a-map.md)
