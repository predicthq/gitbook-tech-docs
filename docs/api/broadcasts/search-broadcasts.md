...
</code></pre></td></tr><tr><td><code>event.entities</code><br>array</td><td><p>Venue <a href="https://docs.predicthq.com/resources/events/#prop-entities">entities</a> linked to the physical event.</p><p></p><p>E.g.</p><pre class="language-json"><code class="lang-json">[
  {
...
</code></pre></td></tr><tr><td><code>event.event_id</code><br>string</td><td><p>The <a href="https://docs.predicthq.com/resources/events/#prop-id">unique identifier</a> of the physical event. Events in the Broadcasts API have the same identifiers as those in the Events API.</p><p><br>E.g. <code>svbfg9xT4YSVUeeAKp</code></p></td></tr><tr><td><code>event.labels</code><br>array</td><td><p>The <a href="https://docs.predicthq.com/resources/events/#prop-labels">labels</a> associated with the physical event.</p><p><br>E.g. <code>["american-football", "nfl", "sport"]</code></p></td></tr><tr><td><code>event.local_rank</code><br>number</td><td><p>The <a href="https://docs.predicthq.com/resources/events/#prop-local_rank">Local Rank</a> number of the physical event. Local Rank represents the physical event’s impact on its local geographical location.</p><p><br>E.g. <code>100</code></p></td></tr><tr><td><code>event.location</code><br>object</td><td><p>Details about the location of the physical event.</p><p><br>Fields:</p><ul><li><code>country</code>: the <a href="https://docs.predicthq.com/resources/events/#prop-country">country code</a>.</li><li><code>geopoint</code>: the latitude and longitude coordinates.</li><li><code>place_hierarchies</code>: <a href="https://docs.predicthq.com/resources/events/#prop-place_hierarchies">place hierarchies</a> of the physical event.</li></ul><p>E.g.</p><pre class="language-json"><code class="lang-json">{
  "geopoint": {
