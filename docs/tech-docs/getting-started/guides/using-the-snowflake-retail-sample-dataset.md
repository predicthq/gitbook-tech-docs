...
2. Embed it in your own forecasting solution for evaluation purposes. Your solution might vary, so PredictHQ does not supply any specific third-party forecasting guides, but a good starting point may be found [here](/broken/pages/YVklA4NJGD6Mf8j7a4ye).
